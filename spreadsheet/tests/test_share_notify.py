...
email body whose link routes to /spreadsheet?id=…
"""
...
class CustomShareNotification(unittest.TestCase):
    def setUp(self):
        patcher = mock.patch("spreadsheet.api.frappe")
    ...
    def test_in_app_notification_has_branded_subject_with_title(self):
        ...
        self.assertIn("spreadsheet", self.notification_payload.get("subject", "").lower())
    ...
    def test_email_body_links_to_the_spa_not_the_desk(self):
        ...
        self.assertIn("/spreadsheet?id=SH-1", message)
